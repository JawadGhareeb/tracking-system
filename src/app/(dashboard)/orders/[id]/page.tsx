...
export default function AdminOrderDetailsPage() {
  ...
  const employees = useMemo(
    () => users
      .filter((user) => ["employee", "موظف", "worker", "عامل"].includes(user.role.name.trim().toLowerCase()))
