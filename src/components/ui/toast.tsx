...
> = {
  success: {
    ...
    cardClass:
      "border-emerald-200/90 bg-[linear-gradient(135deg,#ffffff_0%,#f2fff7_100%)] shadow-[0_20px_35px_rgba(16,185,129,0.18)]",
    iconWrapClass: "bg-emerald-100/80 ring-1 ring-emerald-200",
  ...
  error: {
    ...
    cardClass:
      "border-rose-200/90 bg-[linear-gradient(135deg,#ffffff_0%,#fff1f3_100%)] shadow-[0_20px_35px_rgba(225,29,72,0.2)]",
    iconWrapClass: "bg-rose-100/80 ring-1 ring-rose-200",
  ...
  info: {
    ...
    cardClass:
      "border-sky-200/90 bg-[linear-gradient(135deg,#ffffff_0%,#eff9ff_100%)] shadow-[0_20px_35px_rgba(14,165,233,0.18)]",
    iconWrapClass: "bg-sky-100/80 ring-1 ring-sky-200",
              ...
              <div className="flex items-start gap-3.5">
                ...
                <div className="flex-1 space-y-1">
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <span className="rounded-full bg-[var(--white)]/80 px-2 py-0.5 text-[10px] font-semibold tracking-wide text-[var(--black-200)] ring-1 ring-black/5">
                      {t(style.chipKey)}
                    </span>
                  </div>
                  {item.description ? (
