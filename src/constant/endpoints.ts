...
export const API_ENDPOINTS = {
  ...
  orders: {
    ...
    stageCompletionRequest: (id: string) => `/orders/assigned/${id}/stage-completion`,
    stageCompletionApprove: (id: string, requestId: string) => `/orders/${id}/stage-completion/${requestId}/approve`,
